...
<script>
  ...
  app.controller("angController", function ($scope, $http, $filter) {
    ...
    $scope.page = 1;
    $scope.limit = "10";
    $scope.request = {multy: 1, daily: 1, individual: 1};
    $scope.srchCase = {};
    ...
    $scope.save = function () {
      ...
      $scope.req.multy = $scope.request.multy;
      $scope.req.daily = $scope.request.daily;
      $scope.req.individual = $scope.request.individual;
            ...
            <div class="modal-body">
                <div class="row" id="printable">
                    <table class="table table-striped">
                        ...
                        <tr>
                            <th class="col-md-4 text-right">Individual</th>
                            <td>{{slcted.individual == 2 ? 'Yes':'NO'}}</td>
                        </tr>
                        <tr>
                            <th class="col-md-4 text-right">Multy</th>
                            <td>{{slcted.multy == 2 ? 'Yes':'NO'}}</td>
                        </tr>
                        <tr>
                            <th class="col-md-4 text-right">Daily</th>
                            <td>{{slcted.daily == 2 ? 'Yes':'NO'}}</td>
                        </tr>
                        <tr>
                        ...
                        <div class="form-group col-sm-10">
                            ...
                            <div class="col-xs-9 btn-group">
                                ...
                                <div class="radio col-xs-6">
                                    ...
                                    <label><input type="radio" ng-model="request.individual" value="2"
                            ...
                            <div class="col-xs-9 btn-group">
                                ...
                                <div class="radio col-xs-6">
                                    <label><input type="radio" ng-model="request.daily" value="1"
                                                  class="input-sm">No</label>&nbsp;
                                    <label><input type="radio" ng-model="request.daily" value="2"
                                                  class="input-sm">Yes</label>
                                </div>
                            </div>
                        </div>
