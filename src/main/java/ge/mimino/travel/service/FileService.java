...
//        String fileName = "" + UUID.randomUUID() + (fileExtention.length() > 0 ? ("." + fileExtention) : "");
  ...
  public void generateWord(Integer requestId) throws IOException, InvalidFormatException {

    String resDir = "/poiResources";
...
//    pageMar.setBottom(BigInteger.valueOf(10L));
    ...
    FileOutputStream out = new FileOutputStream(new File(resDir + "/requestDoc.docx"));
